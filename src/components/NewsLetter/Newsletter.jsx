  ...
  return (
    ...
    >
      ...
      <div
        ...
        w-[700px] h-[50px] rounded-[80px]
        border border-[#e3e3e3]"
      >
        <input
          type="email"
          placeholder="Your Email id"
          className="w-[500px] ml-[30px] outline-none border-none
          text-[#616161] text-[16px]"
        />

        <button
          className="w-[200px] h-[50px] rounded-[80px]
          bg-gray-300 text-white text-[16px] cursor-pointer
